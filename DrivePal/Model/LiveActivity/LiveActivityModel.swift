...
final class LiveActivityModel: ObservableObject, DriveSimulatorDelegate {
    ...
    @Published var currentState = DriveState(count: 0, progress: 0.0, leadingImageName: "normal1", trailingImageName: "", expandedImageName: "normal1", timestamp: 0, isWarning: false, motionStatus: "normal")
