...
final class LiveActivityModel: ObservableObject, DriveSimulatorDelegate {
    ...
    @Published var currentState = DriveState(count: 0, progress: 0.0, leadingImageName: .palNormal, trailingImageName: "", expandedImageName: .palNormal, timestamp: 0, isWarning: false, motionStatus: "normal")
